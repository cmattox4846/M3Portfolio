...
export default function Resume(props) {
    ...
    },
    {
        ...
        description: "KnowYourRep is an application that allows novice users to keep informed about how well their elected officials are adhering to the platforms in which they were elected. ",
        subHeading: "Technologies Used: React JS, Bootsrap.!#$!@#$!@#$!@#$"
    },
    {
        title:"GoodGet Eccommerce Website", 
        duration: {fromDate: "2021", toDate: "2021"},
        description: "GoodGet is an e-commerce application that allows users to buy and sell items in a p2p sales experience.",
        subHeading: "Technologies Used: React JS, Bootsrap.@#!@#!@#%!@#%!@#"
    }
    ];
        ...
        <div className='resume-screen-container' key="work-experience">
            ...
            <div className='experience-description'>
                <span className='resume-description-text'>
                    OnPoint Market Research Group is a digital market company that focuses on led generation via sports and music venues
                </span>
            </div>
            <div className='experience-description'>
                <span className='resume-description-text'>-	Developed and maintained Salesforce APIs, interfaces, and Custom database reports.</span>
                <br></br>
                <span className='resume-description-text'>- Provided hardware and software support for end-users in the field.</span>
                <br/>
                <span className='resume-description-text'>- Interfaced with vendors and area staff to ensure proper installation of equipment.</span>
                <br/>
                <span className='resume-description-text'>- Maintaining custom CSS, WordPress, and JavaScript code in order to provide premier Website Design.</span>
            </div>,
